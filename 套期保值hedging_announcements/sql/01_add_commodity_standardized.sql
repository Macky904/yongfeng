-- ============================================================================
-- ⚠️ 本文件为【历史过渡方案】，已被 02_merge_standardized_into_commodity.sql 取代
--
--    01 的做法是新增 commodity_standardized 临时列供人工核对；
--    核对通过后业务确认不保留额外字段，已将结果写回原 commodity 并删除该列。
--    当前库中【不存在】commodity_standardized 字段。
--
--    新环境请直接执行 02 的「路径 B」（一步到位改 commodity），不要跑本文件，
--    否则会重新建出一个多余的列。本文件仅保留标准化规则的推导过程作为存档。
-- ============================================================================
